    ...
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      >
        ...
        <div className="w-full space-y-4">
          ...
          <div>
            <label className="block text-sm font-bold text-blue-900 ml-1 mb-1">Role</label>
            <select
              value={role}
              onChange={(e) =>
                setRole(e.target.value as "student" | "parent" | "educator")
              }
              className="block w-full rounded-2xl border-2 border-blue-100 bg-white/90 px-4 py-3 text-gray-700 focus:border-blue-400 focus:outline-none focus:ring-4 focus:ring-blue-100 transition-all font-bold"
            >
        ...
        <p className="text-base font-bold text-center text-blue-900">
          ...
          <a href="/login" className="text-orange-600 hover:text-orange-700 underline underline-offset-4 decoration-2 transition-colors">
            Sign in
          </a>
        </p>
      </form>
